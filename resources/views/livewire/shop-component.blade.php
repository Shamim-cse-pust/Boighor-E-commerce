     ...
     <div class="container">
         ...
         <div class="row">
             <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                 ...
                 <div class="banner-shop">
                     <a href="#" class="banner-link">
                         <figure><img src="{{ asset('assets/images/Buy_now_banner.jpg') }}" alt=""></figure>
                     </a>
                 </div>
                                 ...
                                 <div class="product product-style-3 equal-elem ">
                                     ...
                                     <div class="product-info">
                                         ...
                                         <a href="#" class="btn add-to-cart"
                                             wire:click.event="store({{ $product->id }},'{{ $product->name }}',{{ $product->regular_price }})">Add
                                             To Cart</a>
             ...
             <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                                             ...
                                             @foreach ($category->subCategories as $scategory)
                                                 <li class="category-item">
                                                     <a href="{{ route('product.category', ['category_slug' => $category->slug, 'scategory_slug' => $scategory->slug]) }}"
                                                         class="cat-link"><i
                                                             class="fa fa-caret-right"></i>{{ $scategory->name }}</a>
                                                 </li>
                                             @endforeach
                                         </ul>
                                     @endif
                 ...
                 {{-- <div class="widget mercado-widget filter-widget" style="padding-top:50px;">
                                 ...
                                 <div class="product product-widget-style">
                                     <div class="thumbnnail">
                                         <a href="detail.html"
                                             ...
                                             <a href="http://127.0.0.1:8000/product/sesher-kbita"
                                     ...
                                     <div class="product-info">
                                         <a href="http://127.0.0.1:8000/product/sesher-kbita"
                                             class="product-name"><span>
                                                 শেষের কবিতা</span></a>
                                         <div class="wrap-price"><span class="product-price">৳165.00</span></div>
                                     </div>
                                 </div>
                             </li>
                             ...
                             <li class="product-item">
                                 <div class="product product-widget-style">
                                     <div class="thumbnnail">
                                         <a href="detail.html"
                                             title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                             <a href="http://127.0.0.1:8000/product/ghumer-ghore"
                                                 class="product-name"><span>
                                                     <figure><img
                                     ...
                                     <div class="product-info">
                                         <a href="http://127.0.0.1:8000/product/ghumer-ghore"
                                             class="product-name"><span>ঘুমের ঘোরে</span></a>
                                         <div class="wrap-price"><span class="product-price">৳150.00</span></div>
                                     </div>
                                 </div>
                             </li>
