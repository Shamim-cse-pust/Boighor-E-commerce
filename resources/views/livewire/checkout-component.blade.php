					...
					<div class="summary-item payment-method">
						...
						<div class="wrap-address-billing">
							...
							<p class="row-in-form">
								...
								<input type="number" name="token" value="" placeholder="token" wire:model="token_no">
						...
						<div class="choose-payment-methods">
							...
							<label class="payment-method">
								<input name="payment-method" id="payment-method-Token" value="Token" type="radio" wire:model="paymentmode">
								<span>Pay With Token</span>
								<span class="payment-desc">Not Working </span>
