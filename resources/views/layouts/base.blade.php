                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: 01784766676" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: (+88) 01784766676</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul>
                                ...
                                {{-- <li class="menu-item lang-menu menu-item-has-children parent">
                                    ...
                                    <ul class="submenu lang">
                                        <li class="menu-item"><a title="বাংলা" href="#"><span
                                                    class="img label-before"><img src="assets/images/bangla-lan.png"
                                                        alt="bangla-lan"></span>বাংলা</a></li>
